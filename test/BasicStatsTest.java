...
public class BasicStatsTest {
    ...
    // test class for undo last added number
    /**
    * 
    */
    @Test
    public void testUndoForLastAdd() {
        double[] numbers = { 2, 3 };
        double undo = BasicStats.mode(numbers);
        assertEquals(2, undo, EPS);

    }

    // test class for emputy undo
    /**
     * 
     */
    ...
    public void testUndoInitial() {
        ...
        double undo = BasicStats.mode(numbers);
        assertEquals(numbers[numbers.length - 1], undo, EPS);
    }
